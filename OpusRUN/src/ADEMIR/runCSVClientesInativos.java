...
public class runCSVClientesInativos {
	...
	public static void main(String[] args) {
		try{
			...
			+ "a.CLIENTES_ID =  c.ID AND a.PLANOS_ACESSO_ID = 255 AND a.STATUS_2 NOT LIKE 'ENCERRADO' or "
			+ "a.CLIENTES_ID =  c.ID AND a.PLANOS_ACESSO_ID = 245 AND a.STATUS_2 NOT LIKE 'ENCERRADO')", Cliente.class);
			...
			File f = new File("F:\\75MFibraUpEUltraMais.csv");
				...
				for (Cliente c : contratosEncerrado) {
							...
							if(c != null && c.getTelefone1() != null || c.getTelefone2() != null || c.getCelular1() != null || c.getCelular2() != null){
								...
								Query q2 = em.createNativeQuery("select * from acesso_cliente a where "									
										+ "a.CLIENTES_ID=:c and a.PLANOS_ACESSO_ID=255  AND a.STATUS_2 NOT LIKE 'ENCERRADO' OR "
										+ "a.CLIENTES_ID=:c and a.PLANOS_ACESSO_ID=245 AND  a.STATUS_2 NOT LIKE 'ENCERRADO' ",  AcessoCliente.class);
								q2.setParameter("c", c);
