	...
	public static void main(String[] args) {
		try{
			...
			Query q = em.createNativeQuery("SELECT * FROM clientes c WHERE EXISTS(SELECT * FROM acesso_cliente a WHERE  "
					+ "a.CLIENTES_ID =  c.ID AND a.PLANOS_ACESSO_ID = 293 AND a.STATUS_2 NOT LIKE 'ENCERRADO')  ", Cliente.class);
			...
			File f = new File("F:\\75mFibraTop.csv");
				...
				for (Cliente c : contratosEncerrado) {
							...
							if(c != null && c.getTelefone1() != null || c.getTelefone2() != null || c.getCelular1() != null || c.getCelular2() != null){
								...
								Query q2 = em.createNativeQuery("select * from acesso_cliente a where "									
										+ "a.CLIENTES_ID=:c and a.PLANOS_ACESSO_ID=293  AND a.STATUS_2 NOT LIKE 'ENCERRADO' ",  AcessoCliente.class);
								q2.setParameter("c", c);
