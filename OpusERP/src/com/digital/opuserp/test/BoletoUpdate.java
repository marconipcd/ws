...
public class BoletoUpdate {
	...
	public static void start() {
		...
		Query q = em.createNativeQuery("SELECT * FROM  contas_receber WHERE  N_NUMERO_SICRED IS NULL AND  N_NUMERO IS NOT NULL AND  STATUS_2 =  'ABERTO' AND REMESSA_ENVIADA = 'SIM' LIMIT 0 , 100", ContasReceber.class);
