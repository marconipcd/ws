...
public class PedidoUtil extends Window {
	...
	public PedidoUtil(boolean modal, boolean center){
	...
	public Table buildTb(){
		...
		tb.setVisibleColumns(new Object[]{"id","cliente.nome_razao","valor","vendedor","entregar"});
