...
public class VeiculoUtil extends Window {
	...
	public VeiculoUtil(boolean modal, boolean center){
	...
	public JPAContainer<Veiculos> buildJpaContainer(){
		container = JPAContainerFactory.make(Veiculos.class, ConnUtil.getEntity());		
	...
	public Table buildTb(){
		...
		tb.setColumnHeader("cod_veiculo", "Código");
		tb.setColumnHeader("tipo", "Nome");
		tb.setColumnHeader("marca", "CPF");
		tb.setColumnHeader("modelo", "Modelo");
		
		//tb.setConverter("id", null);
		
		tb.setVisibleColumns(new Object[]{"cod_veiculo","tipo","marca","modelo"});
			...
			public void itemClick(ItemClickEvent event) {
				...
				if(event.isDoubleClick()){
					...
					if(item.getItemProperty("id")!=null){
						c = VeiculoDAO.find(Integer.parseInt(item.getItemProperty("id").toString()));										
					}
					fireEvent(new VeiculosEvent(getUI(), c));
					close();
		...
		btSalvar = new Button("Ok", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if(tb.getValue()!= null){
					...
					Veiculos c = VeiculoDAO.find(Integer.parseInt(item.getItemProperty("id").toString()));				
					fireEvent(new VeiculosEvent(getUI(), c));
				close();
				}	
			}	
	...
	public void addListerner(VeiculoListerner target){
		try {
			Method method = VeiculoListerner.class.getDeclaredMethod("onSelected",VeiculosEvent.class);
			addListener(VeiculosEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(VeiculoListerner target){
		removeListener(VeiculosEvent.class, target);
	}
	public static class VeiculosEvent extends Event{

		private Veiculos Veiculo;
		
		public VeiculosEvent(Component source, Veiculos Veiculo) {
			super(source);		
	...
	public interface VeiculoListerner{
		public void onSelected(VeiculosEvent event);
	}
}
