...
public class EditarRegimeProprioParaComodatoTotalEditor extends Window {
	...
	public EditarRegimeProprioParaComodatoTotalEditor(Item item, String title, boolean modal){
		this.item = item;
			...
			public void buttonClick(ClickEvent event) {
				if(valid_mac && valid_serial){
					try {	
						...
						fieldGroup.commit();				
						fireEvent(new EditarRegimeProprioParaComodatoTotalEditorEvent(getUI(), item, motivo,codSerialRoteador,codSerialOnu,  true));							
	...
	public Button buildBtCancelar() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if(!fieldGroup.isModified()){
					fieldGroup.discard();				
					fireEvent(new EditarRegimeProprioParaComodatoTotalEditorEvent(getUI(), item,motivo,null,null,false));					
				}else{
							...
							if(event.isConfirm()){
								if(fieldGroup.isValid() && valid_mac){
									try {	
										...
										fieldGroup.commit();				
										fireEvent(new EditarRegimeProprioParaComodatoTotalEditorEvent(getUI(), item,motivo,null,null, true));
	...
	public void addListerner(EditarRegimeProprioParaComodatoTotalEditorListerner target){
		try {
			Method method = EditarRegimeProprioParaComodatoTotalEditorListerner.class.getDeclaredMethod("onClose", EditarRegimeProprioParaComodatoTotalEditorEvent.class);
			addListener(EditarRegimeProprioParaComodatoTotalEditorEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(EditarRegimeProprioParaComodatoTotalEditorListerner target){
		removeListener(EditarRegimeProprioParaComodatoTotalEditorEvent.class, target);
	}
	public static class EditarRegimeProprioParaComodatoTotalEditorEvent extends Event{
		...
		public EditarRegimeProprioParaComodatoTotalEditorEvent(Component source, Item item,String motivo,Integer codSerialRoteador,Integer codSerialOnu, boolean confirm) {
			super(source);
			this.item = item;
			this.motivo = motivo;
	...
	public interface EditarRegimeProprioParaComodatoTotalEditorListerner extends Serializable{
		public void onClose(EditarRegimeProprioParaComodatoTotalEditorEvent event);
	}
