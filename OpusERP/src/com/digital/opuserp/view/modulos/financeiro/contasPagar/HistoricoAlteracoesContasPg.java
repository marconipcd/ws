...
public class HistoricoAlteracoesContasPg extends Window {

	JPAContainer<AlteracoesContasPg> container;
	...
	public HistoricoAlteracoesContasPg(boolean modal, boolean center, Integer codContaPg){
		
		super("Histórico de Ocorrências");
		
		this.codContaPg = codContaPg;
		setWidth("830px");
		setHeight("360px");
	...
	public JPAContainer<AlteracoesContasPg> buildJpaContainer(){
		container = JPAContainerFactory.make(AlteracoesContasPg.class, ConnUtil.getEntity());
		container.addContainerFilter(Filters.eq("conta_pagar", new ContasPagar(codContaPg)));
