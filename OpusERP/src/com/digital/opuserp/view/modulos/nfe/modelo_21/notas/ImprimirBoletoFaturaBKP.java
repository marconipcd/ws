...
public class ImprimirBoletoFaturaBKP implements StreamSource{

	ByteArrayOutputStream baos = new ByteArrayOutputStream();
	PdfWriter writer = null;
	
	PlanoAcesso plano;
	public ImprimirBoletoFaturaBKP(Boleto boleto,NfeMestre nfe,PlanoAcesso plano) throws Exception {
		this.plano = plano;
		...
		try{
			...
			String logo_digital_bb = base + "/WEB-INF/boleto/logo_digital_bb.png";
					...
					str.append("<tr>");
						...
						str.append("<span class='desc_topo_fatura_hash'><strong>"+
						        cad.substring(0,4).toUpperCase()+"."+
								...
								cad.substring(28, 32).toUpperCase()+"</strong></span><br /><br />");
						str.append("</td>");
