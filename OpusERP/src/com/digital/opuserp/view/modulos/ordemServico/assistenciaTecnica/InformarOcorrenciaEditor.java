...
public class InformarOcorrenciaEditor extends Window implements GenericEditor {
	...
	JPAContainer<AlteracoesAssistencia> container;
	public JPAContainer<AlteracoesAssistencia> buildJpaContainer(){
		container = JPAContainerFactory.make(AlteracoesAssistencia.class, ConnUtil.getEntity());
		container.addContainerFilter(Filters.eq("osi", new Osi(codContrato)));
