...
public class ServicoEditor extends Window implements GenericEditor {
	...
	private ComboBox cbOutrasTb;
	
	public ServicoEditor(Item item, String title, boolean modal){
		this.item = item;
	...
	public void buildLayout(){
		...
		vlRoot.addComponent(
				new FormLayout(){					
				{
					...
					TextField txtCod = new TextField("Código");				
		...
		vlRoot.addComponent(
				...
				{					
					...
					cbOutrasTb = new ComboBox ("Permitir outras tabelas");							
					cbOutrasTb.setStyleName("caption-align-servico");
					cbOutrasTb.setNullSelectionAllowed(false);					
					cbOutrasTb.setRequired(true);
					cbOutrasTb.setTextInputAllowed(false);					
					cbOutrasTb.addStyleName("sim-nao");
					cbOutrasTb.addItem("SIM");
					cbOutrasTb.addItem("NAO");

					addComponent(cbOutrasTb);
					fieldGroup.bind(cbOutrasTb, "outras_tb_desc");
					
					if(item.getItemProperty("id").getValue() == null){
						cbOutrasTb.select("NAO");
					}				
		...
		vlRoot.addComponent(
				...
				{					
					...
					ComboBox cbProducao = new ComboBox("Produção");							
					cbProducao.setStyleName("caption-align-servico");
					cbProducao.setNullSelectionAllowed(false);					
					cbProducao.setRequired(true);
					cbProducao.addItem("SIM");
					cbProducao.addItem("NAO");
					cbProducao.setTextInputAllowed(false);
					
					addComponent(cbProducao);
					fieldGroup.bind(cbProducao, "producao");
					
					if(item.getItemProperty("id").getValue() == null){
						cbProducao.select("SIM");
					}
