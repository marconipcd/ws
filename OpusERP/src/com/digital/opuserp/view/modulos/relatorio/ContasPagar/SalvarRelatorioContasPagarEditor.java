...
public class SalvarRelatorioContasPagarEditor extends Window implements GenericEditor {
	...
	public SalvarRelatorioContasPagarEditor(Integer codSubModulo, String title, boolean modal){
		...
		btSalvar = new Button("OK", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				if(txtNome.isValid()&& validName){
					...
					fireEvent(new SalvarRelatorioContasPagarEvent(getUI(),true, txtNome.getValue().toUpperCase()));
					close();
	...
	public Button buildBtCancelar() {
		btCancelar = new Button("Cancelar", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireEvent(new SalvarRelatorioContasPagarEvent(getUI(),false, ""));
				close();
	...
	public void addListerner(SalvarRelatorioContasPagarListerner target){
		try {
			Method method = SalvarRelatorioContasPagarListerner.class.getDeclaredMethod("onClose", SalvarRelatorioContasPagarEvent.class);
			addListener(SalvarRelatorioContasPagarEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(SalvarRelatorioContasPagarListerner target){
		removeListener(SalvarRelatorioContasPagarEvent.class, target);
	}
	public static class SalvarRelatorioContasPagarEvent extends Event{
		
		
		private boolean confirm;
		private String nome;
		
		public SalvarRelatorioContasPagarEvent(Component source, boolean confirm, String nome) {
			super(source);
	...
	public interface SalvarRelatorioContasPagarListerner extends Serializable{
