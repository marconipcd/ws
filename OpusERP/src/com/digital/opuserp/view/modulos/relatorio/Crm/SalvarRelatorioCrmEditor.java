...
public class SalvarRelatorioCrmEditor extends Window implements GenericEditor {
	...
	public SalvarRelatorioCrmEditor(Integer codSubModulo, String title, boolean modal){
		...
		btSalvar = new Button("OK", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				if(txtNome.isValid()&& validName){
					...
					fireEvent(new SalvarRelatorioCrmEvent(getUI(),true, txtNome.getValue().toUpperCase()));
					close();
	...
	public Button buildBtCancelar() {
		btCancelar = new Button("Cancelar", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireEvent(new SalvarRelatorioCrmEvent(getUI(),false, ""));
				close();
	...
	public void addListerner(SalvarRelatorioCrmListerner target){
		try {
			Method method = SalvarRelatorioCrmListerner.class.getDeclaredMethod("onClose", SalvarRelatorioCrmEvent.class);
			addListener(SalvarRelatorioCrmEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(SalvarRelatorioCrmListerner target){
		removeListener(SalvarRelatorioCrmEvent.class, target);
	}
	public static class SalvarRelatorioCrmEvent extends Event{
		
		
		private boolean confirm;
		private String nome;
		
		public SalvarRelatorioCrmEvent(Component source, boolean confirm, String nome) {
			super(source);
	...
	public interface SalvarRelatorioCrmListerner extends Serializable{
