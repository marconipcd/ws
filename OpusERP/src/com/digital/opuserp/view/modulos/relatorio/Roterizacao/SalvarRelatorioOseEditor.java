...
public class SalvarRelatorioOseEditor extends Window implements GenericEditor {
	...
	public SalvarRelatorioOseEditor(Integer codSubModulo, String title, boolean modal){
		...
		btSalvar = new Button("OK", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				if(txtNome.isValid()&& validName){
					...
					fireEvent(new SalvarRelatorioOseEvent(getUI(),true, txtNome.getValue().toUpperCase()));
					close();
	...
	public Button buildBtCancelar() {
		btCancelar = new Button("Cancelar", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireEvent(new SalvarRelatorioOseEvent(getUI(),false, ""));
				close();
	...
	public void addListerner(SalvarRelatorioOseListerner target){
		try {
			Method method = SalvarRelatorioOseListerner.class.getDeclaredMethod("onClose", SalvarRelatorioOseEvent.class);
			addListener(SalvarRelatorioOseEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(SalvarRelatorioOseListerner target){
		removeListener(SalvarRelatorioOseEvent.class, target);
	}
	public static class SalvarRelatorioOseEvent extends Event{
		
		
		private boolean confirm;
		private String nome;
		
		public SalvarRelatorioOseEvent(Component source, boolean confirm, String nome) {
			super(source);
	...
	public interface SalvarRelatorioOseListerner extends Serializable{
