	...
	public void buildLayout(){
		...
		vlRoot.addComponent(
			new FormLayout(){					
			{
				...
				cbOrdenacao.addItem("Nome/Razão Social");
				cbOrdenacao.addItem("CPF/CNPJ");
				cbOrdenacao.addItem("Tipo Pessoa");
				cbOrdenacao.addItem("Inscrição Estadual/RG");
				...
				cbOrdenacao.addItem("Data de Alteração");
...
//					cbResumo.addItem("Código");
					cbResumo.addItem("Nome/Razão Social");
					cbResumo.addItem("CPF/CNPJ");
					cbResumo.addItem("Tipo Pessoa");
					cbResumo.addItem("Inscrição Estadual/RG");
					...
					cbResumo.addItem("Data de Alteração");
...
//		cbFiltro.focus();
		...
		cbFiltro.addItem("Nome/Razão Social");
		cbFiltro.addItem("CPF/CNPJ");
		cbFiltro.addItem("Tipo Pessoa");
		cbFiltro.addItem("Inscrição Estadual/RG");
		...
		cbFiltro.addItem("Data de Alteração");
