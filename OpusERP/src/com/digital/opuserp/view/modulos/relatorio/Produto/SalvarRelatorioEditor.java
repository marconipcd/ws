...
import com.digital.opuserp.view.modulos.relatorio.Cliente.SalvarRelatorioEditor.SalvarRelatorioListerner;
...
public class SalvarRelatorioEditor extends Window implements GenericEditor {
	...
	public SalvarRelatorioEditor(Integer codSubModulo, String title, boolean modal){
		...
		btSalvar = new Button("OK", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				if(txtNome.isValid()&& validName){
					...
					fireEvent(new SalvarRelatorioEvent(getUI(),true, txtNome.getValue().toUpperCase()));
					close();
	...
	public Button buildBtCancelar() {
		btCancelar = new Button("Cancelar", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireEvent(new SalvarRelatorioEvent(getUI(),false, ""));
				close();
	...
	public void addListerner(SalvarRelatorioListerner target){
		try {
			Method method = SalvarRelatorioListerner.class.getDeclaredMethod("onClose", SalvarRelatorioEvent.class);
			addListener(SalvarRelatorioEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(SalvarRelatorioListerner target){
		removeListener(SalvarRelatorioEvent.class, target);
	}
	public static class SalvarRelatorioEvent extends Event{
		
		
		private boolean confirm;
		private String nome;
		
		public SalvarRelatorioEvent(Component source, boolean confirm, String nome) {
			super(source);
	...
	public interface SalvarRelatorioListerner extends Serializable{
