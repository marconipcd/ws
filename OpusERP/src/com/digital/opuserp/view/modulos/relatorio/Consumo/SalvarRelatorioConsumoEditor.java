...
public class SalvarRelatorioConsumoEditor extends Window implements GenericEditor {
	...
	public SalvarRelatorioConsumoEditor(Integer codSubModulo, String title, boolean modal){
		...
		btSalvar = new Button("OK", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				if(txtNome.isValid()&& validName){
					...
					fireEvent(new SalvarRelatorioConsumoEvent(getUI(),true, txtNome.getValue().toUpperCase()));
					close();
	...
	public Button buildBtCancelar() {
		btCancelar = new Button("Cancelar", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireEvent(new SalvarRelatorioConsumoEvent(getUI(),false, ""));
				close();
	...
	public void addListerner(SalvarRelatorioConsumoListerner target){
		try {
			Method method = SalvarRelatorioConsumoListerner.class.getDeclaredMethod("onClose", SalvarRelatorioConsumoEvent.class);
			addListener(SalvarRelatorioConsumoEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(SalvarRelatorioConsumoListerner target){
		removeListener(SalvarRelatorioConsumoEvent.class, target);
	}
	public static class SalvarRelatorioConsumoEvent extends Event{
		
		
		private boolean confirm;
		private String nome;
		
		public SalvarRelatorioConsumoEvent(Component source, boolean confirm, String nome) {
			super(source);
	...
	public interface SalvarRelatorioConsumoListerner extends Serializable{
