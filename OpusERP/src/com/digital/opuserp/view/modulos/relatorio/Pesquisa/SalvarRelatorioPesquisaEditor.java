...
public class SalvarRelatorioPesquisaEditor extends Window implements GenericEditor {
	...
	public SalvarRelatorioPesquisaEditor(Integer codSubModulo, String title, boolean modal){
		...
		btSalvar = new Button("OK", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				if(txtNome.isValid()&& validName){
					...
					fireEvent(new SalvarRelatorioPesquisaEvent(getUI(),true, txtNome.getValue().toUpperCase()));
					close();
	...
	public Button buildBtCancelar() {
		btCancelar = new Button("Cancelar", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireEvent(new SalvarRelatorioPesquisaEvent(getUI(),false, ""));
				close();
	...
	public void addListerner(SalvarRelatorioPesquisaListerner target){
		try {
			Method method = SalvarRelatorioPesquisaListerner.class.getDeclaredMethod("onClose", SalvarRelatorioPesquisaEvent.class);
			addListener(SalvarRelatorioPesquisaEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(SalvarRelatorioPesquisaListerner target){
		removeListener(SalvarRelatorioPesquisaEvent.class, target);
	}
	public static class SalvarRelatorioPesquisaEvent extends Event{
		
		
		private boolean confirm;
		private String nome;
		
		public SalvarRelatorioPesquisaEvent(Component source, boolean confirm, String nome) {
			super(source);
	...
	public interface SalvarRelatorioPesquisaListerner extends Serializable{
