...
public class SalvarRelatorioContasReceberEditor extends Window implements GenericEditor {
	...
	public SalvarRelatorioContasReceberEditor(Integer codSubModulo, String title, boolean modal){
		...
		btSalvar = new Button("OK", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				if(txtNome.isValid()&& validName){
					...
					fireEvent(new SalvarRelatorioContasReceberEvent(getUI(),true, txtNome.getValue().toUpperCase()));
					close();
	...
	public Button buildBtCancelar() {
		btCancelar = new Button("Cancelar", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireEvent(new SalvarRelatorioContasReceberEvent(getUI(),false, ""));
				close();
	...
	public void addListerner(SalvarRelatorioContasReceberListerner target){
		try {
			Method method = SalvarRelatorioContasReceberListerner.class.getDeclaredMethod("onClose", SalvarRelatorioContasReceberEvent.class);
			addListener(SalvarRelatorioContasReceberEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(SalvarRelatorioContasReceberListerner target){
		removeListener(SalvarRelatorioContasReceberEvent.class, target);
	}
	public static class SalvarRelatorioContasReceberEvent extends Event{
		
		
		private boolean confirm;
		private String nome;
		
		public SalvarRelatorioContasReceberEvent(Component source, boolean confirm, String nome) {
			super(source);
	...
	public interface SalvarRelatorioContasReceberListerner extends Serializable{
