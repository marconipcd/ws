...
public class SalvarRelatorioCompraEditor extends Window implements GenericEditor {
	...
	public SalvarRelatorioCompraEditor(Integer codSubModulo, String title, boolean modal){
		...
		btSalvar = new Button("OK", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				if(txtNome.isValid()&& validName){
					...
					fireEvent(new SalvarRelatorioCompraEvent(getUI(),true, txtNome.getValue().toUpperCase()));
					close();
	...
	public Button buildBtCancelar() {
		btCancelar = new Button("Cancelar", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireEvent(new SalvarRelatorioCompraEvent(getUI(),false, ""));
				close();
	...
	public void addListerner(SalvarRelatorioCompraListerner target){
		try {
			Method method = SalvarRelatorioCompraListerner.class.getDeclaredMethod("onClose", SalvarRelatorioCompraEvent.class);
			addListener(SalvarRelatorioCompraEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(SalvarRelatorioCompraListerner target){
		removeListener(SalvarRelatorioCompraEvent.class, target);
	}
	public static class SalvarRelatorioCompraEvent extends Event{
		
		
		private boolean confirm;
		private String nome;
		
		public SalvarRelatorioCompraEvent(Component source, boolean confirm, String nome) {
			super(source);
	...
	public interface SalvarRelatorioCompraListerner extends Serializable{
