...
public class SalvarRelatorioAcessoEditor extends Window implements GenericEditor {
	...
	public SalvarRelatorioAcessoEditor(Integer codSubModulo, String title, boolean modal){
		...
		btSalvar = new Button("OK", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				if(txtNome.isValid()&& validName){
					...
					fireEvent(new SalvarRelatorioAcessoEvent(getUI(),true, txtNome.getValue().toUpperCase()));
					close();
	...
	public Button buildBtCancelar() {
		btCancelar = new Button("Cancelar", new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireEvent(new SalvarRelatorioAcessoEvent(getUI(),false, ""));
				close();
	...
	public void addListerner(SalvarRelatorioAcessoListerner target){
		try {
			Method method = SalvarRelatorioAcessoListerner.class.getDeclaredMethod("onClose", SalvarRelatorioAcessoEvent.class);
			addListener(SalvarRelatorioAcessoEvent.class, target, method);
		} catch (Exception e) {
			System.out.println("Método não Encontrado!");
		}
	}
	public void removeListerner(SalvarRelatorioAcessoListerner target){
		removeListener(SalvarRelatorioAcessoEvent.class, target);
	}
	public static class SalvarRelatorioAcessoEvent extends Event{
		
		
		private boolean confirm;
		private String nome;
		
		public SalvarRelatorioAcessoEvent(Component source, boolean confirm, String nome) {
			super(source);
	...
	public interface SalvarRelatorioAcessoListerner extends Serializable{
