package com.digital.opuserp.view.modulos.configuracoes.config_estoque.cfop;
...
public class CfopEditor extends Window implements GenericEditor {
	...
	public CfopEditor(Item item, String title, boolean modal){
		this.item = item;
