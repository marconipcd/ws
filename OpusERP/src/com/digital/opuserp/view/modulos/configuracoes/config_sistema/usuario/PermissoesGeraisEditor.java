	...
	private void addPermissions(){
		...
		if(tbSubModulos.getValue() != null && ((CheckBox)tbSubModulos.getColumnGenerator("x").generateCell(tbSubModulos, tbSubModulos.getValue(), "x")).getValue()){
			...
			if(submodulo.equals("Clientes")){
				...
				tbPermissao.addItem(new Object[]{"Visualizar Info Tecnicas"}, new Integer(25));	
				tbPermissao.addItem(new Object[]{"Alterar Fiador"}, new Integer(26));
				tbPermissao.addItem(new Object[]{"Remover Material"}, new Integer(27));
				tbPermissao.addItem(new Object[]{"Alterar Tipo Nfe"}, new Integer(28));
				tbPermissao.addItem(new Object[]{"Alterar Ip Fixo"}, new Integer(29));
				tbPermissao.addItem(new Object[]{"Suspender"}, new Integer(30));
				tbPermissao.addItem(new Object[]{"Reativar"}, new Integer(31));
				tbPermissao.addItem(new Object[]{"Bloquear/Desbloquear"}, new Integer(32));
				tbPermissao.addItem(new Object[]{"Agendar Bloqueio/Desbloqueio"}, new Integer(33));
				tbPermissao.addItem(new Object[]{"Funcoes Administrativas"}, new Integer(34));
				tbPermissao.addItem(new Object[]{"Desbloqueio 72h"}, new Integer(35));
				tbPermissao.addItem(new Object[]{"PreContrato"}, new Integer(36));
				tbPermissao.addItem(new Object[]{"Upload arquivo"}, new Integer(37));
				tbPermissao.addItem(new Object[]{"Excluir arquivo"}, new Integer(38));
				tbPermissao.addItem(new Object[]{"Visualizar arquivo"}, new Integer(39));
				tbPermissao.addItem(new Object[]{"Liberar Cartao Cliente"}, new Integer(40));
				tbPermissao.addItem(new Object[]{"Remover pendencia upload"}, new Integer(41));
				...
				tbPermissao.addItem(new Object[]{"Relatorio Recorrencia"}, new Integer(10));				
