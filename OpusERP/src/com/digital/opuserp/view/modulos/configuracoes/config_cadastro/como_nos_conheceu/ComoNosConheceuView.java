...
//				}else{
//					Notification.show("Atenção", "Você não Possui Permissão para Cadastrar uma Categoria", Type.ERROR_MESSAGE);
//				}
			}
		});
...
//							Notification.show("Categoria Alterada com Sucesso!");
				...
				getUI().addWindow(cEditor);
//				}else{
//					Notification.show("Atenção", "Você não Possui Permissão para Editar uma Categoria", Type.ERROR_MESSAGE);
//				}
			}
		});
		btEditar.setEnabled(false);
...
//					}else{					
					...
					GenericDialog gDialog = new GenericDialog("Confirme para Continuar!", "Você deseja realmente Excluir este Registro?", true, true);
...
//				}else{
//					Notification.show("Atenção", "Você não Possui Permissão para Excluir uma Categoria", Type.ERROR_MESSAGE);
//				}
//			}
		});
		btExcluir.setEnabled(false);
